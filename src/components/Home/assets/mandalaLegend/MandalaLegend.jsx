...
class MandalaLegend extends Component {
  ...
  componentDidMount() {
    document
      .getElementById("borderMandala")
      .addEventListener("mouseenter", () =>
        stop(this.bertrandFiltre.bind(this), videos, this.state.selectedSymbole)
      );
  }
        ...
        <ul className="legendMandala">
          ...
          >
            <input
              ...
              id="stories"
              alt="stories"
              onClick={this.filterSymboles.bind(this)}
              src="./assets/images/1.svg"
              value="stories"
              width={this.state.widthSymbole}
            />
            {/* <label htmlFor="stories">
              {this.props.t("categories.stories")}
            </label> */}
          </li>
          <li
            style={{
          ...
          >
            ...
            {/* <label htmlFor="testimonials">
              {this.props.t("categories.testimonials")}
            </label> */}
          </li>
          <li
            style={{
          ...
          >
            <input
              ...
              width={this.state.widthSymbole}
            />
            {/* <label htmlFor="music">{this.props.t("categories.music")}</label> */}
          </li>
        </ul>
      </Fragment>
    );
